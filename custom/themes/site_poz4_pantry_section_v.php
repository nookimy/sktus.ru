...
<!-- End NT (noscript) -->
  ...
  <main>
    ...
    <div class="section-switch pantry-switch poz4-switch garage-plan">
    <img src="/custom/sktus/img/poz4/nav-map.png" class="switch-image switch-active3" usemap="#switchmap" style="">
  ...
  <div>
  <map name="switchmap">
    <area shape="poly" coords="78,52,54,94,68,104,128,121,145,118,144,66,136,63,89,49,86,52" class="switch-area" href="/pozitsiya-4---kladovye-pomescheniya/sektsiya-b/">
    <area shape="poly" coords="146,69,146,118,164,121,223,104,238,95,212,49,202,49,154,62" class="switch-area" href="/pozitsiya-4---kladovye-pomescheniya/sektsiya-v/">
  </map>
  </div>    
  </div>
    <insert name="show_pantryswitch" position="4" section="3">
    <div class="poz4-pantry-section-v garage-plan">
      ...
      <div class="area-hovers">
        <img data-src="/custom/sktus/img/poz4/pantry/v/103.png" />
        <img data-src="/custom/sktus/img/poz4/pantry/v/129.png" />
        <img data-src="/custom/sktus/img/poz4/pantry/v/134.png" />
      </div>
      <map name="areamap">
        <area shape="poly" coords="655,315,673,310,690,367,656,370" class="area-pantryplace" data-number="103" data-square="4.00" data-marginleft="632" data-margintop="238" href="#"/>
        <area shape="poly" coords="416,486,444,486,444,539,416,540" class="area-pantryplace" data-number="129" data-square="3.75" data-marginleft="396" data-margintop="554" href="#"/>
        <area shape="poly" coords="300,517,346,515,346,540,299,539" class="area-pantryplace" data-number="134" data-square="3.00" data-marginleft="293" data-margintop="554" href="#"/>
      </map>
    </div>
    <div class="garage-caption garage-place-caption">
      <p class="dominfo-block-caption dominfo-block-placecaption"><strong>Позиция №4</strong></p>
