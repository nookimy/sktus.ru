...
<!-- End NT (noscript) -->
  ...
  <main>
    ...
    <div class="section-switch pantry-switch poz4-switch">
    <img src="/custom/sktus/img/poz4/nav-map.png" class="switch-image switch-active2" usemap="#switchmap" style="">
  ...
  <map name="switchmap">
    ...
    <insert name="show_pantryswitch" position="4" section="2">
    <div class="poz4-pantry-section-b garage-plan">
      ...
      <div class="area-hovers">
        <img data-src="/custom/sktus/img/poz4/pantry/b/77.png" />
        <img data-src="/custom/sktus/img/poz4/pantry/b/78.png" />
      </div>
      <map name="areamap">
            <area shape="poly" coords="332,487,380,487,380,512,332,510" class="area-pantryplace" data-number="77" data-square="3.15" data-marginleft="323" data-margintop="415" href="#" />
            <area shape="poly" coords="384,488,413,487,414,540,384,542" class="area-pantryplace" data-number="78" data-square="4.00" data-marginleft="366" data-margintop="415" href="#" />
      </map>
    </div>
