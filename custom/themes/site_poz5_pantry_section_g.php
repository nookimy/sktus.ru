...
<!-- End NT (noscript) -->
  ...
  <main>
    ...
    <insert name="show_pantryswitch" position="5" section="4">
    <div class="poz5-pantry-section-g garage-plan">
      ...
      <div class="area-hovers">
        <img data-src="/custom/sktus/img/poz5/pantry/g/1.png" />        
        <img data-src="/custom/sktus/img/poz5/pantry/g/17.png" />
      </div>
      <map name="areamap">
        <area shape="poly" coords="621,385,650,384,650,437,622,437" class="area-pantryplace" data-number="171" data-square="3.70" data-marginleft="604" data-margintop="312" href="#"/>
        
        <area shape="poly" coords="584,302,611,301,611,356,584,356" class="area-pantryplace" data-number="154" data-square="3.80" data-marginleft="564" data-margintop="228" href="#"/>
