...
?>
<div class="areawrap start-page-version-2">
    <img src="/custom/sktus/img/map--ver2.png" class="areaimg" usemap="#areamap" />
    ...
    <div class="area-hovers">
        ...
        <img data-src="/custom/sktus/img/hover-poz16.png" />
        <img data-src="/custom/sktus/img/hover-poz17.png" />
        <img data-src="/custom/sktus/img/hover-poz18.png" />
    ...
    <div class="house-numbers">
        <i class="house-number house-number-gray house-number-1">1</i>
        <i class="house-number house-number-gray house-number-2">2</i>
        <i class="house-number house-number-gray house-number-3">3</i>
        ...
        <i class="house-number house-number-gray house-number-16">16</i>
        <i class="house-number house-number-gray house-number-17">17</i>
        <i class="house-number house-number-gray house-number-18">18</i>
        ...
        <i class="house-number house-number-green house-number-24">24</i>
        <i class="house-number house-number-green house-number-25">25</i>
        <i class="house-number house-number-green house-number-26">26</i>
        <i class="house-number house-number-comfort house-number-6a">6a</i>
        <i class="house-number house-number-comfort house-number-7a">7a</i>
    ...
    <div class="comfort-class">
        <i class="house-comfort">Дома повышенной комфортности</i>
    </div>
    <a href="/" onclick="document.cookie = 'start-page-version=1; path=/; location.reload();'" class="change-start-page-version">
        <div class="change-start-page-version__image change-start-page-version__image--2"></div>
        <div class="change-start-page-version__text">
            Посмотреть
            <small>другой ракурс</small>
            <span class="change-start-page-version__arrow"></span>
        </div>
    </a>
    <map name="areamap">
      ...
      <area shape="poly" coords="998, 316, 1061, 313, 1069, 289, 1130, 290, 1127, 363, 1135, 374, 1108, 386, 1108, 400, 1053, 383, 993, 402" class="area-buble area-bubble-nolink" data-position="8" data-status="Проект" href="#"/>
      ...
      <area shape="poly" coords="252, 593, 267, 587, 269, 572, 327, 558, 389, 590, 396, 740, 314, 772, 260, 743" class="area-buble area-bubble-nolink" data-position="16" data-status="Проект" href="#"/>
      <area shape="poly" coords="411, 540, 432, 533, 432, 521, 475, 510, 490, 510, 491, 519, 543, 542, 545, 680, 473, 704, 418, 677" class="area-buble area-bubble-nolink" data-position="17" data-status="Проект" href="#"/>
      <area shape="poly" coords="300, 495, 317, 488, 319, 477, 361, 463, 375, 464, 376, 475, 428, 497, 425, 530, 410, 536, 411, 637, 393, 642, 391, 590, 335, 563, 336, 554, 302, 546" class="area-buble area-bubble-nolink" data-position="18" data-status="Проект" href="#"/>
      ...
      <area shape="poly" coords="329, 384, 367, 383, 468, 413, 664, 419, 726, 404, 747, 416, 745, 519, 653, 555, 642, 551, 547, 572, 544, 537, 497, 517, 497, 505, 467, 496, 462, 508, 432, 521, 428, 496, 378, 468, 379, 461, 358, 454, 330, 468" class="area-buble" data-position="24" data-address="" data-status="Дом строится" data-apartments="Квартиры в продаже" href="doma/pozitsiya-24/"/>
      <area shape="poly" coords="399, 365, 520, 320, 673, 372, 673, 407, 490, 399, 445, 405, 400, 388" class="area-buble" data-position="25" data-address="Миначева, 11 к.1" data-status="Дом сдан" data-apartments="Квартиры в продаже" href="doma/pozitsiya-25"/>
      <area shape="poly" coords="170, 213, 204, 216, 206, 298, 270, 311, 363, 301, 363, 277, 393, 273, 429, 287, 428, 344, 391, 358, 393, 384, 361, 373, 325, 384, 329, 424, 253, 443, 135, 387, 129, 275" class="area-buble area-bubble-nolink" data-position="26" data-status="Проект" href="#"/>
      <area shape="poly" coords="227, 795, 348, 778, 521, 700, 560, 725, 559, 824, 418, 896, 368, 927, 248, 943, 231, 894" class="area-buble" data-position="6a" data-address="" data-status="Дом сдан" data-apartments="Квартиры в продаже" href="doma/pozitsiya-6a"/>
      <area shape="poly" coords="610, 666, 801, 748, 796, 848, 749, 873, 573, 783, 572, 683" class="area-buble" data-position="7a" data-address="" data-status="Дом сдан" data-apartments="Квартиры в продаже" href="doma/pozitsiya-7a"/>
