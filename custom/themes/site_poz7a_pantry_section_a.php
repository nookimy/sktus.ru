  ...
  <insert name="show_form" module="feedback" id="6" template="requestcall">
    <insert name="show_form" module="feedback" site_id="133" template="howmuch">
      ...
      <insert name="show_include" file="badges">
        ...
        <main>
          <div class="section-switch section7a-switch section7a-switch-pantry">
            <div class="compass-7a">
              <img src="/custom/sktus/img/compasses/compass-7a.png">
            </div>
            <img src="/custom/sktus/img/poz7a/section-switch/map.png" class="switch-image switch-active1" usemap="#switchmap" style="">
            <div class="switch-hovers">
              <img data-src="/custom/sktus/img/poz7a/section-switch/1.png">
            </div>
            <div>
              <map name="switchmap">
                <area shape="poly" coords="0,0,0,59,104,59,103,0" class="switch-area" href="/pozitsiya-7a---kladovye-pomescheniya/sektsiya-a/">
              </map>
            </div>
          </div>

          <a href="#" class="backbutton"></a>
          <insert name="show_pantryswitch" position="7a" section="1">
            <div class="poz7a-pantry-section-a garage-plan">
              ...
              <div class="area-hovers">
                <img data-src="/custom/sktus/img/poz7a/pantry/01.png">
                <img data-src="/custom/sktus/img/poz7a/pantry/03.png">
                <img data-src="/custom/sktus/img/poz7a/pantry/07.png">
                <img data-src="/custom/sktus/img/poz7a/pantry/12.png">
                <img data-src="/custom/sktus/img/poz7a/pantry/14.png">
              </div>
              <map name="areamap">
                <area shape="rect" coords="133, 195, 175, 244" class="area-pantryplace" data-number="1" data-square="3.3" data-marginleft="70" data-margintop="195" href="#"/>
                <area shape="rect" coords="135, 247, 218, 282" class="area-pantryplace" data-number="3" data-square="4.0" data-marginleft="144" data-margintop="284" href="#"/>
                <area shape="rect" coords="253, 194, 321, 226" class="area-pantryplace" data-number="7" data-square="3.4" data-marginleft="326" data-margintop="178" href="#"/>
                <area shape="rect" coords="96, 445, 145, 493" class="area-pantryplace" data-number="12" data-square="3.2" data-marginleft="31" data-margintop="438" href="#"/>
                <area shape="rect" coords="98, 494, 144, 542" class="area-pantryplace" data-number="14" data-square="3.3" data-marginleft="31" data-margintop="488" href="#"/>

              </map>
            </div>
            <div class="garage-caption garage-place-caption">
              <p class="dominfo-block-caption dominfo-block-placecaption"><strong>Позиция №7a</strong></p>
