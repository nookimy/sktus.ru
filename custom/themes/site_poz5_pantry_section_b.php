...
<!-- End NT (noscript) -->
  ...
  <main>
    ...
    <insert name="show_pantryswitch" position="5" section="2">
    <div class="poz5-pantry-section-b garage-plan">
      ...
      <div class="area-hovers">
        <img data-src="/custom/sktus/img/poz5/pantry/b/1.png" />        
      </div>
      <map name="areamap">        
        <area shape="poly" coords="633,412,682,412,682,437,633,437" class="area-pantryplace" data-number="80" data-square="3" data-marginleft="689" data-margintop="393" href="#"/> 
      </map>
    </div>
