...
<!-- End NT (noscript) -->
  ...
  <main>
    <insert name="show_sectionswitch" position="6" section="5">
    <a href="#" class="backbutton"></a>
    <div class="section-wrap poz6-section45">
      <img src="/custom/sktus/img/poz6/sectionmap.png" class="areaimg" usemap="#areamap" />
      <div class="sectioninfo">
        <p style="margin-left:357px;margin-top:251px;"><strong>2</strong> 73,95м<sup>2</sup></p>
        <p style="margin-left:607px;margin-top:251px;"><strong>2</strong> 79,75м<sup>2</sup></p>
        <p style="margin-left:344px;margin-top:430px;"><strong>1</strong> 45,65м<sup>2</sup></p>
        <p style="margin-left:553px;margin-top:430px;"><strong>2</strong> 67,2м<sup>2</sup></p>
      </div>
