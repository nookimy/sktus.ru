...
<!-- End NT (noscript) -->
  ...
  <main>
    ...
    <div class="section-wrap poz6-section3">
      <img src="/custom/sktus/img/poz6/sectionmap.png" class="areaimg" usemap="#areamap" />
      <div class="sectioninfo">
        <p style="margin-left:357px;margin-top:251px;"><strong>2</strong> 76,4м<sup>2</sup></p>
        <p style="margin-left:603px;margin-top:251px;"><strong>2</strong> 77,5м<sup>2</sup></p>
        <p style="margin-left:306px;margin-top:428px;"><strong>1</strong> 49,5м<sup>2</sup></p>
        <p style="margin-left:605px;margin-top:428px;"><strong>2</strong> 72,6м<sup>2</sup></p>
      </div>
      <div class="area-hovers">
        <img data-src="/custom/sktus/img/poz6/section3-room1.png" />
        <img data-src="/custom/sktus/img/poz6/section3-room2.png" />
