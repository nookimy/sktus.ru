...
<!-- End NT (noscript) -->
  ...
  <main>
    ...
    <div class="section-wrap poz6-section1">
      <img src="/custom/sktus/img/poz6/sectionmap.png" class="areaimg" usemap="#areamap" />
      <div class="sectioninfo">
        <p style="margin-left:326px;margin-top:249px;"><strong>3</strong> 99,3м<sup>2</sup></p>
        <p style="margin-left:649px;margin-top:249px;"><strong>2</strong> 75,1м<sup>2</sup></p>
        <p style="margin-left:346px;margin-top:428px;"><strong>2</strong> 65,85м<sup>2</sup></p>
        <p style="margin-left:562px;margin-top:428px;"><strong>1</strong> 45,75м<sup>2</sup></p>
        <p style="margin-left:635px;margin-top:428px;"><strong>1</strong> 42,85м<sup>2</sup></p>
      </div>
      <div class="area-hovers">
        <img data-src="/custom/sktus/img/poz6/section1-room1.png" />
        <img data-src="/custom/sktus/img/poz6/section1-room2.png" />
