...
<!-- End NT (noscript) -->
  ...
  <main>
    <insert name="show_sectionswitch" position="6" section="6">
    <a href="#" class="backbutton"></a>
    <div class="section-wrap poz6-section6">
      <img src="/custom/sktus/img/poz6/sectionmap.png" class="areaimg" usemap="#areamap" />
      <div class="sectioninfo">
        <p style="margin-left:357px;margin-top:251px;"><strong>2</strong> 74,15м<sup>2</sup></p>
        <p style="margin-left:607px;margin-top:251px;"><strong>2</strong> 80,05м<sup>2</sup></p>
        <p style="margin-left:344px;margin-top:430px;"><strong>1</strong> 45,65м<sup>2</sup></p>
        <p style="margin-left:553px;margin-top:430px;"><strong>2</strong> 67,3м<sup>2</sup></p>
      </div>
      <div class="area-hovers">
        <img data-src="/custom/sktus/img/poz6/section6-room1.png" />
        <img data-src="/custom/sktus/img/poz6/section6-room2.png" />
        <img data-src="/custom/sktus/img/poz6/section6-room3.png" />
        <img data-src="/custom/sktus/img/poz6/section6-room4.png" />
      </div>
      <map name="areamap">
