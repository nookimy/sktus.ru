...
$level = $attributes["level"] ? $attributes["level"] : 3;
if ( count($this->diafan->_site->breadcrumb) == $level ) {
    echo '<div class="floorpath floorpath--commercial">';
    $caption = "";
    $section = "";
    ...
    echo '<div class="floorpath-position">' . $this->diafan->_site->breadcrumb[1]['name'] . '</div>';
    echo '</div>';
}
