...
<!-- End NT (noscript) -->
  ...
  <main>
    <insert name="show_sectionswitch" position="24" section="3">
    <a href="#" class="backbutton"></a>
    <div class="section-wrap poz24-defaultsection poz24-section2">
      <img src="/custom/sktus/img/poz24/section-map.png" class="areaimg" usemap="#areamap" />
      <div class="sectioninfo">
        <p style="margin-left:244px;margin-top:477px;"><strong>3</strong> 81,65м<sup>2</sup></p>
        <p style="margin-left:588px;margin-top:477px;"><strong>1</strong> 35,60м<sup>2</sup></p>
        <p style="margin-left:656px;margin-top:264px;"><strong>2</strong> 58,55м<sup>2</sup></p>
      </div>
      <div class="area-hovers">
        <img data-src="/custom/sktus/img/poz24/section2-1.png" />
        <img data-src="/custom/sktus/img/poz24/section2-2.png" />
        <img data-src="/custom/sktus/img/poz24/section2-3.png" />
      </div>
      <map name="areamap">
