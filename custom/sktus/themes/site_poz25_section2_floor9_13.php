...
<!-- End NT (noscript) -->
  ...
  <main>
    <insert name="show_sectionswitch" position="25" section="2">
    <a href="#" class="backbutton"></a>
    <div class="section-wrap poz25-section2">
      <img src="/custom/sktus/img/poz25/section-map.png" class="areaimg" usemap="#areamap" />
      <div class="sectioninfo">
        <p style="margin-left:198px;margin-top:268px;"><strong>2</strong> 58,90м<sup>2</sup></p>
        <p style="margin-left:265px;margin-top:474px;"><strong>1</strong> 35,00м<sup>2</sup></p>
        <p style="margin-left:430px;margin-top:474px;"><strong>1</strong> 37,65м<sup>2</sup></p>
        <p style="margin-left:670px;margin-top:474px;"><strong>1</strong> 35,60м<sup>2</sup></p>
        <p style="margin-left:726px;margin-top:268px;"><strong>2</strong> 58,90м<sup>2</sup></p>
      </div>
      <div class="area-hovers">
        <img data-src="/custom/sktus/img/poz25/section2-room1.png" />
