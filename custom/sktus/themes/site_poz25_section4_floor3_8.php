...
<!-- End NT (noscript) -->
  ...
  <main>
    ...
    <div class="section-wrap poz25-section4">
      <img src="/custom/sktus/img/poz25/section-map.png" class="areaimg" usemap="#areamap" />
      <div class="sectioninfo">
        <p style="margin-left:261px;margin-top:477px;"><strong>3</strong> 81,90м<sup>2</sup></p>
        <p style="margin-left:600px;margin-top:474px;"><strong>1</strong> 35,85м<sup>2</sup></p>
        <p style="margin-left:663px;margin-top:268px;"><strong>2</strong> 58,70м<sup>2</sup></p>
      </div>
