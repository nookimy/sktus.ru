...
<!-- End NT (noscript) -->
  ...
  <main>
    ...
    <insert name="show_commercialswitch" position="7a" section="1">
    <div class="section-wrap poz7a-commercial-section-a">
      ...
      <div class="area-hovers">
        <img data-src="/custom/sktus/img/poz7a/commercial/section-A-1.png" />
        <img data-src="/custom/sktus/img/poz7a/commercial/section-A-2.png" />
      </div>
      <map name="areamap">
        <area shape="poly" coords="143,106,201,106,202,37,401,37,401,71,486,69,487,213,539,211,540,330,482,333,480,362,415,360,414,330,310,330,309,366,142,366" class="area-pantryplace area-commercialplace" data-number="1" data-square="234.4" data-marginleft="286" data-margintop="204" href="#"/>
        <area shape="poly" coords="560,98,560,68,739,69,740,332,674,330,674,360,606,362,606,330,549,331,549,214,606,213,603,98" class="area-pantryplace area-commercialplace" data-number="2" data-square="107.9" data-marginleft="626" data-margintop="204" href="#"/>
      </map>
    </div>
