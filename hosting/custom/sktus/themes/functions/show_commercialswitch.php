...
';
  ...
  <div class="switch-hovers">
    <img data-src="/custom/sktus/img/poz6a/section-switch/blocks-AB.png" style="opacity: 0;"/>
    <img data-src="/custom/sktus/img/poz6a/section-switch/3.png" style="opacity: 0;" />
    <img data-src="/custom/sktus/img/poz6a/section-switch/4.png" style="opacity: 0;" />
  </div>
  <div>
      <map name="switchmap">
        <area shape="poly" coords="0,0,127,0,127,54,0,54" class="switch-area"/>
        <area shape="poly" coords="125,0,125,53,182,51,205,1" class="switch-area"/>
