...
<!-- End NT (noscript) -->
  ...
  <main>
    <insert name="show_sectionswitch" position="24" section="2">
    ...
    <div class="section-wrap poz24-defaultsection poz24-section2">
      ...
      <div class="sectioninfo">
        ...
        <p style="margin-left:588px;margin-top:477px;"><strong>1</strong> 35,95м<sup>2</sup></p>
        <p style="margin-left:656px;margin-top:264px;"><strong>2</strong> 59,00м<sup>2</sup></p>
      </div>
