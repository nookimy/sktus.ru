...
<!-- End NT (noscript) -->
  ...
  <main>
    ...
    <div class="poz1-commercial-switch">

    </div>
    <div class="section-wrap poz1-commercial-wrap">
      <img src="/custom/sktus/img/poz1/commercial/map.png" class="areaimg" usemap="#areamap" />
      <div class="pantryplaceinfo commercialplaceinfo">
        <p><strong></strong><span><i></i>м<sup>2</sup></span></p>
      </div>
      <div class="area-hovers">
        <img data-src="/custom/sktus/img/poz1/commercial/12.png" />
      </div>
      <map name="areamap">
        <area shape="poly" coords="420,214,593,214,594,323,707,322,706,510,422,511" class="area-pantryplace area-commercialplace" data-number="12" data-square="301.5" data-marginleft="529" data-margintop="338" href="#"/>
      </map>
    </div>
    <div class="garage-caption garage-place-caption">
      <p class="dominfo-block-caption dominfo-block-caption"><strong>Позиция №1 | Лукина, д.5</strong></p>
