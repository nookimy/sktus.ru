...
<!-- End NT (noscript) -->
  ...
  <main>
    <insert name="show_sectionswitch" position="7a" section="3">
    <a href="#" class="backbutton"></a>
    <div class="section-wrap poz7a-section3">
      ...
      <div class="sectioninfo">
        ...
        <p style="margin-left:570px;margin-top:89px;"><strong>2</strong> 64,39м<sup>2</sup></p>
      </div>
