...
<!-- End NT (noscript) -->
  ...
  <main>
    <insert name="show_sectionswitch" position="25" section="4">
    <a href="#" class="backbutton"></a>
    <div class="section-wrap poz25-section4-floor1">
      <img src="/custom/sktus/img/poz25/section-map.png" class="areaimg" usemap="#areamap" />
      <div class="sectioninfo">
        <p style="margin-left:361px;margin-top:477px;"><strong>1</strong> 38,45м<sup>2</sup></p>
        <p style="margin-left:600px;margin-top:474px;"><strong>1</strong> 36,45м<sup>2</sup></p>
        <p style="margin-left:663px;margin-top:268px;"><strong>2</strong> 59,50м<sup>2</sup></p>
      </div>
      <div class="area-hovers">
        <img data-src="/custom/sktus/img/poz25/section4-floor1-room1.png" />
        <img data-src="/custom/sktus/img/poz25/section45-room2.png" />
        <img data-src="/custom/sktus/img/poz25/section4-room3.png" />
      </div>
      <map name="areamap">
        <area shape="poly" coords="339,382,341,566,420,567,420,604,520,604,519,382" class="area-buble" href="#"/>
