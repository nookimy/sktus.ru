...
<!-- End NT (noscript) -->
  ...
  <main>
    ...
    <div class="section-wrap poz6-section2-after3">
      <img src="/custom/sktus/img/poz6/sectionmap.png" class="areaimg" usemap="#areamap" />
      <div class="sectioninfo">
        <p style="margin-left:326px;margin-top:249px;"><strong>3</strong> 102,9м<sup>2</sup></p>
        <p style="margin-left:649px;margin-top:249px;"><strong>2</strong> 77,7м<sup>2</sup></p>
        <p style="margin-left:346px;margin-top:428px;"><strong>2</strong> 65,45м<sup>2</sup></p>
        <p style="margin-left:562px;margin-top:428px;"><strong>1</strong> 45,45м<sup>2</sup></p>
        <p style="margin-left:635px;margin-top:428px;"><strong>1</strong> 42,25м<sup>2</sup></p>
      </div>
      <div class="area-hovers">
        <img data-src="/custom/sktus/img/poz6/section2-after3-room1.png" />
        <img data-src="/custom/sktus/img/poz6/section2-after3-room2.png" />
